(function()
{
	...
	Sidebar.prototype.refresh = function()
	{
		...
		// 便笺本已经在initPalettes方法中加载，不需要再次加载
	};
	...
	Sidebar.prototype.init = function()
	{
        ...
        this.addStencilsToIndex = false; // 这个要设置为true，不然找不到模板
	...
	{
		// 确保便笺本显示在第一个位置
	var stdEntries = [{title: mxResources.get('scratchpad'), id: '.scratchpad'},
	...
	Sidebar.prototype.initPalettes = function()
	{
        ...
        // 加载便笺本，确保它显示在第一个位置
        var ui = this.editorUi;
        if (ui.scratchpad == null && ui.isScratchpadEnabled()) {
            ui.toggleScratchpad();
        }
        ...
        // }
        // if (!this.palettes['advanced']) {
        //     this.addAdvancedPalette(false);
        // }
        
        // 电网设备（必须）
        this.setCurrentSearchEntryLibrary('grid');
        this.addStencilShape('grid', '设备', this.stencilDoc,
