...
(function()
{
	...
	Menus.prototype.init = function()
	{
			...
			Menus.prototype.createMenubar = function(container)
			{
					...
					editorUi.getServiceName() != 'atlassian')
				{
					...
					if (themeMenu != null)
					{
						...
						document.querySelector('#graphCon').appendChild(elt);
		...
		{
			if (window['disableOper']){
				this.addMenuItems(menu, ['undo', 'redo', '-', 'copyAsImage', '-', 'findReplace', '-', 'editData', 'editTooltip', '-',
		...
		viewPanelsMenu.funct = function(menu, parent)
		{
			...
			if (!window.drawflag) {
				...
				editorUi.menus.addMenuItems(menu, ['format', '-',
					'findReplace', 'layers', 'tags', 'chatWindowTitle', 'outline', '-'], parent);
			}
		...
		this.put('view', new Menu(mxUtils.bind(this, function(menu, parent)
		{
			...
			else
			{
				...
				if (!window['drawflag']) {
					this.addMenuItems(menu, ['toggleShapes']);
				...
				if (window['drawflag']) {
					this.addMenuItems(menu, ['tooltips', 'guides',
						'-', 'connectionArrows', 'connectionPoints'], parent);
				} else {
