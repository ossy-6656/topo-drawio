 ...
 */
Menus.prototype.defaultFonts = ['SimSun', 'Helvetica', 'Verdana', 'Times New Roman', 'Garamond', 'Comic Sans MS',
...
Menus.prototype.init = function()
{
	...
	this.put('view', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		if (window['drawflag']) {
			...
			concat(['outline', 'layers', '-', 'tooltips',
				'guides', '-', 'connectionArrows', 'connectionPoints'], parent));
		} else {
			this.addMenuItems(menu, ((this.editorUi.format != null) ? ['format'] : []).
	...
	{
		if (window['drawflag']) {
			this.addMenuItems(menu, ['undo', 'redo', '-',
