...
mxGraphView.prototype.defaultGridColor = '#848484';
mxGraphView.prototype.defaultDarkGridColor = '#252525';
// mxGraphView.prototype.defaultDarkGridColor = '#141414';
...
Graph = function(container, model, renderHint, stylesheet, themes, standalone)
{
	...
	if (typeof mxVertexHandler !== 'undefined')
	{
	    ...
	    {
			if (window.drawflag) {
				let b1 =  isForceRubberBandEvent.apply(this, arguments) ||
					(mxClient.IS_CHROMEOS && mxEvent.isShiftDown(me.getEvent())) ||
					(mxUtils.hasScrollbars(this.graph.container) && mxClient.IS_FF && mxClient.IS_WIN && me.getState() == null && mxEvent.isTouchEvent(me.getEvent()));
				let b2 = mxEvent.isAltDown(me.getEvent());
				return b1 && b2;
			}
			else
			{
...
if (typeof mxVertexHandler !== 'undefined')
{
	(function()
	{
		...
		mxEdgeHandler.prototype.fixedHandleImage = HoverIcons.prototype.mainHandle;

		// mxEdgeHandler.prototype.endFixedHandleImage = HoverIcons.prototype.endFixedHandle;
		mxEdgeHandler.prototype.endFixedHandleImage = HoverIcons.prototype.mainHandle;
