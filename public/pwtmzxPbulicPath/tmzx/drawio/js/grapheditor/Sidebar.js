 ...
 */
function Sidebar(editorUi, container, stencilDoc)
{
	this.stencilDoc = stencilDoc;
...
Sidebar.prototype.init = function()
{
	...
	// this.addGeneralPalette(true); // 移除通用分类
...
Sidebar.prototype.addPalette = function(id, title, expanded, onInit)
{
    ...
    if (id == 'L.scratchpad')
    {
        var firstChild = this.wrapper.firstChild;
        if (firstChild != null)
        {
            this.wrapper.insertBefore(elt, firstChild);
            this.wrapper.insertBefore(outer, elt.nextSibling);
        }
        else
        {
...
Sidebar.prototype.addStencilPalette2 = function(id, title, stencilNode, style, ignore, onInit, scale, tags, customFns, groupId, expanded)
{
	scale = (scale != null) ? scale : 1;
	...
	else
	{
		this.addPalette(id, title, expanded, mxUtils.bind(this, function(content)
		{
			...
			let xmlDoc = stencilNode;
			if (xmlDoc != null && xmlDoc.documentElement != null)
			{
				mxStencilRegistry.parseStencilSet(xmlDoc.documentElement, mxUtils.bind(this, function(packageName, stencilName, displayName, w, h)
				{
					if (ignore == null || mxUtils.indexOf(ignore, stencilName) < 0)
					{
						content.appendChild(this.createVertexTemplate('shape=' + packageName + stencilName.toLowerCase() + style,
...
Sidebar.prototype.addStencilShape = function(id, title, stencilNode, style, ignore, onInit, scale, tags, customFns, groupId, expanded)
{
    scale = (scale != null) ? scale : 1;
    ...
    if (xmlDoc != null && xmlDoc.documentElement != null)
    {
        mxStencilRegistry.parseStencilSet(xmlDoc.documentElement, null, true);
    }
};
/**
 * Adds the given stencil palette.
