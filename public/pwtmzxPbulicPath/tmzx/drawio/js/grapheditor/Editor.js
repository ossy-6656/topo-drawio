...
Editor.darkColor = (Editor.enableCssDarkMode) ? '#000' : '#18141D';
...
(function()
{
	...
	let preValidateBackgroundPage = mxGraphView.prototype.validateBackgroundPage;
	mxGraphView.prototype.validateBackgroundPage = function()
	{
		var graph = this.graph;
		if (window['drawflag']){
			preValidateBackgroundPage.call(this);
		}
		else
		{
	...
	mxGraphView.prototype.createSvgGrid = function(color, factor)
	{
		...
		var svg =  '<svg width="' + size + '" height="' + size + '" xmlns="' + mxConstants.NS_SVG + '">' +
		    ...
		    '<path d="M ' + tmp2 + ' 0 L 0 0 0 ' + tmp2 + '" fill="none"  opacity="0.6" stroke="' + color + '" stroke-width="1"/>' +
