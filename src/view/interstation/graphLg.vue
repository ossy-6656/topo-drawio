...
// 导入 G 文件转换工具
import { convertFacGBufferToSvg } from './utils/facGToSvg.js' // G 文件转 SVG
// import { checkEditZjtPermission } from '@/api/tmzx/abnormalchange/index.ts'

// 导入其他工具
import $bus from '@/utils/bus'                                           // 全局事件总线
import customSymbolStr from '@/view/graph/data/symbol.js'                           // 自定义 SVG 符号
import LGSvgParser from './lg/LGSvgParser.js'                 // SVG 解析器
import {
